# You can nest a dictionary inside a dictionary.
# If there are several users for a website, each with a unique username, you can use the usernames as the keys in a dictionary.
